...
public interface MypageRepository {
	...
	@Update("update member_c set password = #{password}, name = #{name}, tell = #{tell}, email = #{email}, company = #{company}, address = #{address}, old_address = #{oldAddress}, is_permit=2 , is_modify=1, permit_date=current_date where id = #{id}")
