		...
		<div class="box1">
			...
			<div class="myinfo">
				<div id="name">
					...
					<div class="user_id" style="display: none;">${authentication.id}</div>
				...
				<div id="infobox" onclick="location.href='/purchase/my-purchase'">
					<div id="infobox1">
...
<script type="text/javascript" src="../../../resources/js/mypage/mypage_common.js"></script>
