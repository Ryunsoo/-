...
<%@ include file="/WEB-INF/views/include/chat/chat.jsp" %>
	...
	<div class="wrap">
		...
		<link rel="stylesheet"
			href="../../../resources/css/community/view_board.css" />
					...
					<div id="view_page_top_user_info">
						...
						<div id="content_info">
							...
							<c:if test="${authentication.id eq board.id}">
								<div id="dib">|</div>
								<div id="modify"
									onClick="location.href ='http://localhost:9090/community/modify?boardIdx=${board.boardIdx}'">수정</div>
								<div id="delete" style="cursor: pointer;"
									onclick="deleteModal('${board.boardIdx}')">삭제</div>
							</c:if>
						</div>
					</div>
					<!--view 페이지 맨위 사용자 정보끝-->
