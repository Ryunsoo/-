         ...
         <div class='wrapper'>
            <div class='select_wrapper'>
               <div class='sub_menu'>
                  ...
                  <div id='join_btn' onclick="location.href='/admin/join-finish-list'"><button>가입 승인</button></div>
                  <div id='modify_btn' onclick="location.href='/admin/modify-finish-list'"><button class='selected'>수정 승인</button></div>
               </div>
					...
					<div class='list'>
						<table>
							<thead>
							 ...
							 <c:if test="${not empty modifyFinishList}">
								<c:forEach items="${modifyFinishList}" var="mfl">
									<tbody id="modify">
										<tr>
											<td>수정</td>
											<td>${mfl.id}</td>
					...
					<div class='page'>
						<c:if test="${paging.startPage != 1}">
							<i class="fas fa-caret-left"
								onclick="location.href = '/admin/modify-finish-list?nowPage=1&cntPerPage=${paging.cntPerPage}'"></i>
						</c:if>
						<div>
						...
						<c:if test="${paging.endPage != paging.lastPage}">
							<i class="fas fa-caret-right"
								onclick="location.href = '/admin/modify-finish-list?nowPage=${paging.endPage+1}&cntPerPage=${paging.cntPerPage}'"></i>
						</c:if>
					</div>
				</div>
			</div>
